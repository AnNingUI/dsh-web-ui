...
const zh = {
  ...
  'settings.title': '右侧面板',
  'settings.description': '选择右侧面板提供方（aionui-panel 即将弃用）。',
  'settings.rightPanel': '使用哪个右侧面板',
  'settings.rightPanelHint': '默认使用 DSH-better-sidebar（推荐）。选择 aionui-panel 时挂载 Explorer / Preview 与 SCM 变更面板，注册 /aionui-panel 路由并开始工作区监视与 git 轮询；选择 DSH-better-sidebar 时本面板不挂载，上述路由与监视停止。',
  'settings.providerBetterSidebar': '使用 DSH-better-sidebar',
  'settings.providerAionui': '使用 aionui-panel（即将弃用）',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'settings.description': 'Choose the right-panel provider (aionui-panel is deprecated).',
  'settings.rightPanel': 'Which right panel to use',
  'settings.rightPanelHint': 'DSH-better-sidebar is the default (recommended). Selecting aionui-panel mounts the Explorer / Preview and SCM changes panels, registers the /aionui-panel routes and starts workspace watching and git polling; selecting DSH-better-sidebar keeps this panel unmounted and stops those routes and watchers.',
  'settings.providerBetterSidebar': 'Use DSH-better-sidebar',
  'settings.providerAionui': 'Use aionui-panel (deprecated)',
