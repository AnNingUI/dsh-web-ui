window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function syntheticEntry(packageName) {
		...
		function entryForPackage(packageName) {
		...
		*/
		...
		function activeSkinEntry() {
			if (hotOverride !== void 0) return hotOverride.pkg === null ? void 0 : entryForPackage(hotOverride.pkg);
